...
%----------------------------------------------------------------------------------------
	...
	%----------------------------------------------------------------------------------------
	\clearpage
	\input{sections/introduzione}	% Introduzione
	\input{sections/cplex}		% Descrizione della struttura del programma
	\input{sections/genetico}		% Problemi implementativi
	\input{sections/confronto}    % Descrizione degli esperimenti
	\input{sections/conclusioni}    % Conclusioni
	\appendix						
	\input{sections/codice}		% Come eseguire il codice
	%----------------------------------------------------------------------------------------
	%	CONTENT
	%----------------------------------------------------------------------------------------
